                ...
                <div className="card-body content-overlay pb-0">
                    <div className="mb-md-5 py-5">
                        <div className="col-xl-6 col-lg-8 col-md-10 mx-auto mb-sm-5 mb-4 px-0 text-center">
                            <h1 className="display-5 text-light opacity-150 mt-sm-5 my-4">
                                Welcome <span style={{ "color": "#33cabb" }}>Adomovies.com</span>
                            </h1>
                            <h4 className="display-8 text-white mb-5">We&apos;re excited to have you join our community of avid viewers</h4>
                            <button type="button" style={{ "backgroundColor": "#33cabb" }} className="btn btn-success text-dark d-block w-100" href="#signin-modal" data-bs-toggle="modal">
                                GET STARTED
                            </button>
                        </div>
                        <div className="col-xl-6 col-lg-8 col-md-10 mx-auto mb-sm-5 mb-4 px-0 text-center">
