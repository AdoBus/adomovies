        ...
        <>
            ...
            {person.deathday !== null ?
                <>
                    ...
                    <PersonInfo title="Deathday" value={`${moment(person.deathday).format('LL')} (${moment(person.birthday).from(person.deathday, true)} old)`} />
                </> :
                <PersonInfo title="Birthday" value={`${moment(person.birthday).format('LL')} (${moment(person.birthday).fromNow(true)} old)`} />
