...
export default function Tv() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const discoverApi = await fetch(`${process.env.tmdburl}/3/discover/tv?api_key=${process.env.tmdbkey}&language=en-US&page=1&sort_by=popularity.desc`);
    ...
    return (
        <Layout title="Adomovies - Popular TV Series">
            <>
                ...
                <div className="container mt-5 pt-5 p-0">
                    <div className="row g-0 mt-n3">
                        <div id="xyzz" name="2" className="col-lg-12 col-xl-12 position-relative overflow-hidden pb-5 pt-4 px-3 px-xl-4 px-xxl-5">
                            <h2 className="h5 mb-5 mt-md-3 mt-5 text-light">Popular TV Series</h2>
                            {
                                discover.results && discover.results.length > 0 ? <Pagination discover={discover} media_type='tv' pagination_type="discover" /> :
